...
SECRET_KEY = 'django-insecure-s(yk+soschnhjdf*z3p*qqib+!r$z2&_o%elg#m&b(0ro-#s(m'
...
LOGOUT_REDIRECT_URL = 'main'  # Имя URL или прямой путь
LOGIN_REDIRECT_URL = 'main'  # Имя URL или прямой путь (например, '/')
